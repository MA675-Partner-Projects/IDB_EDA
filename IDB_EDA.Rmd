...
# variable selection
IDB_sub <- IDB |>
  select(-CD_MUNICIPIO, -DT_GERACAO, -HH_GERACAO, -ANO_ELEICAO, -SG_UF, -CD_MUN_SIT_BIOMETRICA, -DS_MUN_SIT_BIOMETRICA, -NR_ZONA, -DS_GENERO, -DS_ESTADO_CIVIL, -DS_FAIXA_ETARIA, -DS_GRAU_ESCOLARIDADE)
...
IDB_sub <- IDB_sub |>
  mutate(name_muni = as.factor(name_muni),
